...
var _reactPlannerContext = _interopRequireDefault(
  require("../../react-planner-context")
);
var _catalogItem = _interopRequireDefault(require("./catalog-item"));
var _catalogBreadcrumb = _interopRequireDefault(
  require("./catalog-breadcrumb")
);
var _catalogPageItem = _interopRequireDefault(require("./catalog-page-item"));
var _catalogTurnBackPageItem = _interopRequireDefault(
  require("./catalog-turn-back-page-item")
);
var _contentContainer = _interopRequireDefault(
  require("../style/content-container")
);
...
var historyContainer = _objectSpread(
  _objectSpread({}, searchContainer),
  {},
  {
...
var CatalogList = function CatalogList(_ref) {
  ...
  var _useState = (0, _react.useState)(currentCategory.categories),
    _useState2 = _slicedToArray(_useState, 2),
    categories = _useState2[0],
    setCategories = _useState2[1];
  var _useState3 = (0, _react.useState)(elementsToDisplay),
  ...
  if (page !== "root") {
    ...
    breadcrumbComponent = /*#__PURE__*/ _react["default"].createElement(
      _catalogBreadcrumb["default"],
      {
  ...
  var turnBackButton =
    pathSize > 0
      ? /*#__PURE__*/ _react["default"].createElement(
          _catalogTurnBackPageItem["default"],
          {
            key: pathSize,
