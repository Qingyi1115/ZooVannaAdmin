...
import EditEducationalContentForm from "../../components/SpeciesManagement/ViewSpeciesDetailsPage/EditEducationalContentForm";
import useApiJson from "../../hooks/useApiJson";
import Species from "../../models/Species";

function EditEducationalContentPage() {
  ...
  return (
    <div className="p-10">
      <div className="flex w-full flex-col gap-6 rounded-lg border border-stroke bg-white p-20 text-black shadow-default dark:border-strokedark">
        {curSpecies && <EditEducationalContentForm curSpecies={curSpecies} />}
      </div>
    </div>
  );
}

export default EditEducationalContentPage;
