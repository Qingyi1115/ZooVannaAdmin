          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {(employee.superAdmin ||
                employee.keeper ||
                employee.planningStaff?.plannerType == "CURATOR" ||
                employee.planningStaff?.plannerType == "NUTRITIONIST") && (
                  <SidebarLinkGroup
                    activeCondition={
                        ...
                        <React.Fragment>
                          ...
                          >
                            <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                              ...
                              <li>
                                <NavLink
                                  to="/enclosure/createnewenclosure"
                                  className={({ isActive }) =>
                                    "group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white " +
                                    (isActive && "!text-white")
                                  }
                      ...
                      <React.Fragment>
                        ...
                        >
                          <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                            ...
                            <li>
                              <NavLink
                                to="/employeeAccount/allemployeeabsence"
                                className={({ isActive }) =>
                                  "group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white " +
                                  (isActive && "!text-white")
                                }
                    ...
                    {(handleClick, open) => {
                      return (
                        <React.Fragment>
                          <NavLink
                            to="#"
                            className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark ${(pathname === "/zooevent" ||
                              pathname.includes("zooevent")) &&
                              "bg-graydark"
                              }`}
                            onClick={(e) => {
                              e.preventDefault();
