  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const assignAnimalsToAnimalActivityApi = async () => {
      try {
        ...
        // success
        toastShadcn({
          description: "Successfully added animals to animal activity",
        });
        ...
        toastShadcn({
          ...
          description:
            "An error has occurred while adding animal to animal activity: \n" +
            error.message,
        });
      }
    };
    ...
    <div>
      ...
      >
        ...
        >
          ...
          />
          {/* <Form.ValidityState>{validateAnimals}</Form.ValidityState> */}
        </Form.Field>
