                    ...
                    <TableRow>
                        ...
                        {curEmployee.keeper &&
                            <TableRow>
                                ...
                                <TableCell colSpan={1}>{beautifyText(curEmployee.keeper.keeperType)}</TableCell>
                        ...
                        {curEmployee.keeper &&
                            <TableRow>
                                ...
                                <TableCell colSpan={1}>{beautifyText(curEmployee.keeper.specialization)}</TableCell>
                                {!curEmployee.keeper.isDisabled &&
                                    <TableCell colSpan={1}>
                    ...
                    <TableRow>
                        ...
                        {curEmployee.generalStaff &&
                            <TableRow>
                                ...
                                <TableCell colSpan={1}>{beautifyText(curEmployee.generalStaff.generalStaffType)}</TableCell>
                    ...
                    <TableRow>
                        ...
                        {curEmployee.planningStaff &&
                            <TableRow>
                                ...
                                <TableCell colSpan={1}>{beautifyText(curEmployee.planningStaff.plannerType)}</TableCell>
                        ...
                        {curEmployee.planningStaff &&
                            <TableRow>
                                <TableCell className="w-1/6 font-bold">Specialization Type</TableCell>
                                <TableCell colSpan={1}>{beautifyText(curEmployee.planningStaff.specialization)}</TableCell>
                                {!curEmployee.planningStaff.isDisabled &&
                                    <TableCell colSpan={1}>
