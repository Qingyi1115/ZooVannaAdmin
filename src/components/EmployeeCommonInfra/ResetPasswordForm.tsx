  ...
  return (
    <div className="flex w-full justify-center">
      {isNotUsed === true ? (
        ...
        <div className="text-md ml-35 flex w-full justify-start">
          The link is invalid. The link is either already expired or used.
          Please ask the account manager for another link.
        </div>
      )}
    </div>
  );
