            ...
            <tr style={{ marginTop: "1em" }}>
              ...
              <td>
                <FormTextInput
                  ...
                  onChange={(e) => {
                    setEditingLayer(
                      editingLayer.merge({ name: e.target.value })
                    );
                  }}
                />
              </td>
            ...
            <tr>
              ...
              <td>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditingLayer(
                      editingLayer.merge({ opacity: e.target.value / 100 })
                    )
                  }
                />
              </td>
            ...
            <tr>
              ...
              <td>
                <FormNumberInput
                  ...
                  onChange={(e) =>
                    setEditingLayer(
                      editingLayer.merge({ altitude: e.target.value })
                    )
                  }
                />
              </td>
            ...
            <tr>
              ...
              <td>
                <FormNumberInput
                  ...
                  onChange={(e) =>
                    setEditingLayer(
                      editingLayer.merge({ order: e.target.value })
                    )
                  }
                />
              </td>
